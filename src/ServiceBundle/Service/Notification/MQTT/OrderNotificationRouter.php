...
class OrderNotificationRouter implements CallRouterInterface
{
    ...
    const NOTIFICATION_FOR_WORKER_METHOD = 'sendNotificationForWorker';
    const NOTIFICATION_FOR_WORKERS_METHOD = 'sendNotificationForWorkers';
    const NOTIFICATION_FOR_CUSTOMER_METHOD = 'sendNotificationForCustomer';
    ...
    const ROLES_TO_NOTIFY = [
        ...
        OrderStatus::STATUS_PRICE_ADDED          => [
            self::NOTIFICATION_FOR_CUSTOMER_METHOD,
            self::NOTIFICATION_FOR_WORKERS_METHOD,
            self::NOTIFICATION_FOR_MANAGERS_METHOD,
            self::NOTIFICATION_FOR_ADMINS_METHOD,
        ],
        ...
        OrderStatus::STATUS_WORKER_ADDED         => [
            self::NOTIFICATION_FOR_WORKER_METHOD,
            self::NOTIFICATION_FOR_CUSTOMER_METHOD,
            self::NOTIFICATION_FOR_ADMINS_METHOD,
            self::NOTIFICATION_FOR_MANAGERS_METHOD,
        ],
